...
//Example - the min node will be to the far left, the max to the far right
//  50
// 17  - is added to left of 50, because it's smaller
//   23 - is added to right of 17 because it is larger
...
bst.remove(7);
console.log(bst.findMax()); //6 - proving 7 was removed
console.log(bst.isPresent(4)); //false - proving it was removed correctly
